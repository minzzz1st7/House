      ...
      <div class="container">
        ...
        <div class="form-control form-control-sm p-4 text-center">
          <div class="d-flex justify-content-center align-center flex-wrap">
            <p>
              <span class="search-element">대분류</span>
              <input
                id="L"
            ...
            <p>
              <span class="search-element">중분류</span>
              <input
                id="M"
                class="text-input"
                name="dong"
            ...
            <p>
              <span class="search-element">소분류</span>
              <input
                id="S"
                class="text-input"
                name="dong"
          ...
          <!-- <input type="button" class="callAPI" value="callAPI" /> -->
        </div>
        ...
        <div class="row">
          <div class="col-sm-4">
            <button
              id="inteestConfirm"
              class="btn container p-2 my-5 border btn-primary"
              style="width: 40%; background-color: #00bfff; min-width: 180px"
            >
              관심 지역 확인
            </button>
            <div class="container-sm" id="interestList"></div>
          </div>
          <div class="col-sm-8">
