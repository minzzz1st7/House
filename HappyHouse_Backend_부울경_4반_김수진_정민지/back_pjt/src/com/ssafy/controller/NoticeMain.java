...
public class NoticeMain extends HttpServlet {
	...
	private void Noticeupdate(HttpServletRequest request, HttpServletResponse response) throws IOException {
			String updateId = request.getParameter("noticeID");
			...
			System.out.println("============="+ updateId + noticeTitle + noticeContent+ "===========");
	...
	private void searchByID(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String noticeID = request.getParameter("noticeID");
			...
			request.getRequestDispatcher("/noticeSelect.jsp").forward(request, response);
			}catch(Exception e){
			e.printStackTrace();
